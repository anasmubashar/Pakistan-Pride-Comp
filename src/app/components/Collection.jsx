...
export default function Collection() {
  return (
    <div className="sm:h-[45vh] h-auto bg-[url('/Light3.png')] text-white flex flex-col items-center">
      <p className="text-white mt-6">HUGE COLLECTION</p>
      <h2 className="text-white mt-3 text-4xl font-bold">AI-Powered Design</h2>
      <div className=" w-[90%] md:w-[70%] mx-auto gap-4 flex flex-col md:flex-row justify-center mt-10 sm:pb-0 pb-14">
