  ...
  return (
    <div className="bg-[#111204] min-h-screen w-full flex flex-col items-center pt-10">
      ...
      <div class="grid place-items-center min-h-screen mx-auto">
        <div className="grid grid-cols-6 md:grid-cols-12 px-10 mt-10 mx-auto">
          {visionData.map((Item) => (
            <div
              key={Item.subTitile}
              className="col-span-12 md:col-span-6 border-[#13250A] border-2 rounded-3xl flex m-3 pr-2 "
            >
